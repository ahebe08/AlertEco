...
class _LoginPageState extends State<LoginPage> {
  ...
  String? _validatePhone(String? value) {
    ...
    // Validation améliorée pour numéro français
    String cleanPhone = value.replaceAll(RegExp(r'[\s\.\-]'), '');

    // Accepter les formats: 0123456789, +33123456789, 0033123456789
    if (!RegExp(r'^(?:(?:\+|00)33|0)[1-9](?:[0-9]{8})$').hasMatch(cleanPhone)) {
      return 'Format de numéro invalide (ex: 0123456789)';
    }
    return null;
  }
